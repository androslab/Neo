(function ($) {
	...
	/*global jQuery,setTimeout,location,setInterval,YT,clearInterval,clearTimeout,pixelentity,ajaxurl,WPSetAsThumbnail,wpCookies */
	...
	function PeQuickImage(target, conf) {
		...
		function clickHandler(e) {
			console.log(multi,win.peQuickImageCallback);
