...
class PeThemeAsset {
	...
	public function registerAssets() {
		...
		if ($this->minifyJS) {
			...
			$this->addScript("framework/js/pe/init.js",array("pe_theme_boot","jquery","pe_theme_controller"),"pe_theme_init");
		}

		// bootstrap files
		$this->addStyle("framework/js/bootstrap/css/bootstrap.css",array(),"pe_theme_bootstrap");
		$this->addStyle("framework/js/bootstrap/css/bootstrap-responsive.css",array("pe_theme_bootstrap"),"pe_theme_bootstrap_responsive");
		$this->addScript("framework/js/bootstrap/bootstrap.min.js",array("jquery"),"pe_theme_bootstrap");
	...
	public static function addAsset($type,$res,$deps = NULL,$name = NULL) {
		if (!isset($name)) {
			$name = $res;
		}
		$fun = "wp_register_$type";
		$file = file_exists(get_stylesheet_directory() . "/$res") ? get_stylesheet_directory_uri()."/$res" : PE_THEME_URL."/$res";
		$fun($name,$file,$deps,self::version($res));
	}

	public static function addScript($res,$deps = NULL,$name = NULL) {
		self::addAsset("script",$res,$deps,$name);
	}
